...
class DailyFragment : Fragment() {
    private lateinit var adapter : FirebaseRecyclerAdapter<MainLesson, LessonViewHolder>
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val fo = FirebaseRecyclerOptions.Builder<MainLesson>().setQuery(databaseReference, MainLesson::class.java).build()
        adapter = object : FirebaseRecyclerAdapter<MainLesson, LessonViewHolder>(fo){
            ...
            override fun onBindViewHolder(p0: LessonViewHolder, p1: Int, p2: MainLesson) {
